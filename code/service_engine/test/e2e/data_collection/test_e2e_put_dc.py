...
def test_e2e_put_data_collection(data_collection_single):
  ...
  assert response.getcode() == 200 #The fact that the dc exists means the fixture was able to call the put. If we get something else it mean the fixiture was about to create
