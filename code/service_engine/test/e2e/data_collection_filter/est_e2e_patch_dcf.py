...
def test_e2e_patch_data_collection_filter():
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_no_change():
  BASE_URL = environ.get('API_BASE_URL')
  pack_name = "blarf"
  filter_name = ''.join(random.choices(string.ascii_letters,k=10))
  body = {
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_bad_schema():
  BASE_URL = environ.get('API_BASE_URL')
  pack_name = "blarf"
  filter_name = ''.join(random.choices(string.ascii_letters,k=10))
  body = {
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_content_type_xml():
  BASE_URL = environ.get('API_BASE_URL')
  pack_name = "blarf"
  body = ""
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_not_match():
  BASE_URL = environ.get('API_BASE_URL')
  filter_name = ''.join(random.choices(string.ascii_letters,k=10))
  pack_name = "blarf"
  body = {
