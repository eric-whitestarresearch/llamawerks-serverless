...
def test_e2e_patch_data_collection_filter(data_collection_filter_single):
  BASE_URL = environ.get('API_BASE_URL')
  
  updated_body = data_collection_filter_single['body']
  updated_body['variables'].append({
    "name": "color",
    "type": "string"
  })
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_no_change(data_collection_filter_single):
  BASE_URL = environ.get('API_BASE_URL')
  
  data= bytes(dumps(data_collection_filter_single['body']).encode("utf-8"))
  req = urllib.request.Request(f"{BASE_URL}/service_engine/{data_collection_filter_single['pack_name']}/filter", data=data, method='PATCH')
  req.add_header("Content-Type", "application/json")
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_bad_schema(data_collection_filter_single):
  BASE_URL = environ.get('API_BASE_URL')
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_not_exist():
  BASE_URL = environ.get('API_BASE_URL')
  ...
  req = urllib.request.Request(f"{BASE_URL}/service_engine/{pack_name}/filter", data=data, method='PATCH')
  req.add_header("Content-Type", "application/json")
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_no_content_type():
  BASE_URL = environ.get('API_BASE_URL')
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_not_match(data_collection_filter_single):
  BASE_URL = environ.get('API_BASE_URL')
  
  data= bytes(dumps(data_collection_filter_single['body']).encode("utf-8"))
  req = urllib.request.Request(f"{BASE_URL}/service_engine/{data_collection_filter_single['pack_name']}asdf/filter", data=data, method='PATCH')
  req.add_header("Content-Type", "application/json")
...
@pytest.mark.skipif(environ.get('API_BASE_URL') == None, reason="e2e not enabled")
def test_e2e_patch_data_collection_filter_invalid_json():
  BASE_URL = environ.get('API_BASE_URL')
