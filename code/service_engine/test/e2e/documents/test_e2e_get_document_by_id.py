...
def test_e2e_get_document_by_id(document_multi):
  ...
  req = urllib.request.Request(f"{BASE_URL}/service_engine/{document_multi[0]['pack_name']}/data_collection/{document_multi[0]['document_collection_name']}/id/{document_multi[0]['doc_id']}")
...
def test_e2e_get_document_by_id_not_exist(document_single):
  ...
  req = urllib.request.Request(f"{BASE_URL}/service_engine/{document_single['pack_name']}/data_collection/{document_single['document_collection_name']}/id/{doc_id}")
